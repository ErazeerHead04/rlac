...
![Figure 1. Bubblelines—Hogwarts houses across Rowling texts](https://erazeerhead04.github.io/rlac/assets/images/Houses.png)
...
![Figure 4. Links—co-occurrence network for Harry, Dumbledore, Snape, Voldemort, Malfoy](https://erazeerhead04.github.io/rlac/assets/images/links.png)
...
The Mandala visualization shows how key terms like Harry, Snape, and Voldemort cluster together, revealing their strong relational connections and central roles in the narrative’s semantic structure.
...
The TextualArc visualization shows how key terms rise and fall across the corpus over time, revealing shifts in narrative emphasis and when certain characters or themes become most prominent.
